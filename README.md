...
This skill implements the Node.js-specific patterns from [project-arch-core](https://github.com/abczsl520/project-arch-core) — the language-agnostic architecture principles for AI-assisted development.
